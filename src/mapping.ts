...
import { LSP7 } from "../generated/EasyAuction/LSP7";
...
export function handleNewAuction(event: NewAuction): void {
  ...
  let biddingERC20Contract = LSP7.bind(addressBiddingToken);
  let auctioningERC20Contract = LSP7.bind(addressAuctioningToken);
  ...
  let symbolAuctioningToken = auctioningERC20Contract
    .getData(
      Bytes.fromByteArray(
  ...
  let symbolBiddingToken = biddingERC20Contract
    .getData(
      Bytes.fromByteArray(
        ByteArray.fromHexString(
          "0x2f0a68ab07768e01943a599e73362a0e17a63a72e94dd2e384d2c1d4db932756"
